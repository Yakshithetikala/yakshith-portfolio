...
const Footer = () => {
  return <footer className="bg-background border-t border-white/10 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/yakshithetikala" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center hover:bg-primary/30 transition-colors duration-300 group">
                  <Linkedin className="w-5 h-5 text-primary group-hover:scale-110 transition-transform duration-300" />
                </a>
                <a href="mailto:yakshith@example.com" className="w-10 h-10 bg-secondary/20 rounded-lg flex items-center justify-center hover:bg-secondary/30 transition-colors duration-300 group">
                  <Mail className="w-5 h-5 text-secondary group-hover:scale-110 transition-transform duration-300" />
                </a>
                <a href="#" className="w-10 h-10 bg-accent/20 rounded-lg flex items-center justify-center hover:bg-accent/30 transition-colors duration-300 group">

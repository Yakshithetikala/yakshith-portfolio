...
const ProjectsSection = () => {
  ...
  return <section id="projects" ref={sectionRef} className="py-20 lg:py-32 bg-background relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {projects.map((project, index) => <div key={index} className="scroll-animate group" style={{
                ...
                <div className="glass rounded-2xl overflow-hidden border border-white/10 hover:border-primary/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.technologies.map((tech, techIndex) => <span key={techIndex} className="px-3 py-1 bg-secondary/20 rounded-full text-secondary text-sm font-medium border border-secondary/30">
                          {tech}
                        </span>)}
                    </div>
